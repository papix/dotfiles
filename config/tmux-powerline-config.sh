...
# line 2: date + cpu + branch on left + claude usage on right
...
export TMUX_POWERLINE_STATUS_FORMAT_LEFT="#[align=left]#(bash -lc 'source \"${HOME}/.tmux/plugins/tmux-powerline/lib/headers.sh\"; tp_process_settings; TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(\"date_compact 31 255\" \"cpu_usys 166 235\" \"git_branch_status 64 235 default_separator no_sep_bg_color no_sep_fg_color no_spacing_disable no_separator_disable\"); tp_print_powerline_side left')"
